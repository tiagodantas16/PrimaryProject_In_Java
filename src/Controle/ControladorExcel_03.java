 ...
 * @author Tiago Dantas
 */
public class ControladorExcel_03 implements ActionListener {
    ...
    public ControladorExcel_03(VistaExcel vistaE, ModeloExcel modeloE){
        this.vistaE= vistaE;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == vistaE.btn_Importar){
            ...
            dao.Importar_03(modexcel);//Comando para inserir dados no banco.
