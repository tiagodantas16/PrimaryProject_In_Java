 ...
 * @author Tiago Dantas
 */
public class ControladorExcel_05 implements ActionListener {
    ...
    public ControladorExcel_05(VistaExcel vistaE, ModeloExcel modeloE){
        this.vistaE= vistaE;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == vistaE.btn_Importar){
            ...
            dao.Importar_05(modexcel);//Comando para inserir dados no banco.
