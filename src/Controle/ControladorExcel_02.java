 ...
 * @author Tiago Dantas
 */
public class ControladorExcel_02 implements ActionListener {
    ...
    public ControladorExcel_02(VistaExcel vistaE, ModeloExcel modeloE){
        this.vistaE= vistaE;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == vistaE.btn_Importar){
            ...
            dao.Importar_02(modexcel);//Comando para inserir dados no banco.
