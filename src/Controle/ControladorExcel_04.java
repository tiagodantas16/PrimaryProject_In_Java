 ...
 * @author Tiago Dantas
 */
public class ControladorExcel_04 implements ActionListener {
    ...
    public ControladorExcel_04(VistaExcel vistaE, ModeloExcel modeloE){
        this.vistaE= vistaE;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == vistaE.btn_Importar){
            ...
            dao.Importar_04(modexcel);//Comando para inserir dados no banco.
